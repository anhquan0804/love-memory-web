...
// Exposed on window so settings.js can call it
window.closeNav = closeNav;

window.applyTheme = function applyTheme(isDark) {
...
window.applyTheme(document.documentElement.getAttribute('data-theme') === 'dark');
